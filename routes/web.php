...
Route::get('/provincias/{departamento}', function ($departamento) {
    return \App\Models\Provincia::where('departamento_id', $departamento)->get();
});

Route::get('/distritos/{provincia}', function ($provincia) {
    return \App\Models\Distrito::where('provincia_id', $provincia)->get();
});
